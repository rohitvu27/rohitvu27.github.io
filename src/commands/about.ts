...
const createAbout = (): string[] => {
  ...
  const tryhackme =
    `<img src='https://i.pinimg.com/564x/e4/9e/cf/e49ecf40c7fdf87b783f5d2b575fe517.jpg' width='16' style='vertical-align:middle; margin-right:4px; border-radius:10%' />` +
    `${TRYHACKME}`;
  ...
  string += `<a target='_blank' href='https://tryhackme.com/p/${command.social.tryhackme}'>tryhackme.com/p/${command.social.tryhackme}</a>`;
  about.push(string);
